                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="relative group">
                                            <img src="{{ asset('storage/' . $news->image) }}"
                                                 alt="News Image"
                                                 class="w-full max-w-xs rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <div class="h-full">
                                ...
                                <div class="relative h-full">
                                    ...
                                    <textarea id="content" name="content" rows="10"
                                              class="pl-10 w-full h-full min-h-[200px] px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100 resize-y transition duration-150">{{ $news->content }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                            ...
                            <div class="flex space-x-3">
                                <button type="button" onclick="window.location.href='{{ route('news.show', $news) }}'"
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700 dark:text-blue-400">
                            <p>You are currently editing: <span class="font-medium">"{{ $news->title }}"</span></p>
                            <p class="mt-1">Created: {{ $news->created_at->format('F j, Y') }} • Last updated: {{ $news->updated_at->format('F j, Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
