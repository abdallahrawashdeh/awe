<div id="default-carousel" class="relative w-full max-w-full mx-auto overflow-hidden bg-[#101010]">
    <div class="relative h-48 sm:h-64 md:h-96 w-full overflow-hidden bg-[#101010]">
        ...
        <!-- Centered Text -->
        <div class="absolute inset-0 flex items-center justify-center px-4 sm:px-6 z-30">
            <h2
                id="delayed-text"
                class="text-white text-xl sm:text-3xl md:text-5xl font-bold text-center leading-snug max-w-[90%] sm:max-w-2xl md:max-w-4xl"
...
<style>
    ...
    @media (min-width: 640px) {
        #default-carousel > div::after { height: 28px; }
    }

    @media (min-width: 768px) {
        #default-carousel > div::after { height: 40px; }
    }
</style>
