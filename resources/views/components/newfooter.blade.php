...
<footer class="w-full">
    ...
    <img src="{{ asset('images/logoAWD.png') }}" alt="AWD Logo" class="h-20 md:h-24 w-auto object-contain">
</a>
            ...
            <div class="py-7 border-t border-gray-200">
                <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    ...
                    <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                        ...
                        <a href="https://www.linkedin.com/company/advanced-works-design/home/"  class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-900">
...
<a href="https://www.facebook.com/p/Advanced-Works-Design-61568655066923/" target="_blank" rel="noopener noreferrer" class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
    <svg class="w-[0.625rem] h-[1.125rem] text-white" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.35714 8.99998L7.75 6.10714H5V4.22943C5 3.39527 5.30826 2.73214 6.59554 2.73214H7.875V0.116071C7.16295 0.0111607 6.36607 0 5.58929 0C3.20536 0 1.5 1.44643 1.5 4.11607V6.10714H0V8.99998H1.5V16H5V8.99998H7.35714Z" fill="currentColor"/>
    </svg>
</a>
                    </div>
                </div>
