...
<div class="w-full mt-0 bg-white rounded-xl shadow-2xl p-5 md:p-5 lg:p-20 animate-fadeInUp">
  <h3 class="text-3xl font-bold text-gray-800 mb-4 border-b-2 pb-2 border-[#e9bc64]">
     نظرة عامة على شركة الأعمال المتقدمة للهندسة:
  </h3>
  <p id="description" class="text-gray-600 leading-relaxed text-lg overflow-hidden transition-[max-height] duration-500 max-h-20">
   مرحبًا بكم في شركة الأعمال المتقدمة للهندسة، حيث نحن ملتزمون بتقديم خدمات هندسية شاملة لعملائنا، بما في ذلك مطوري العقارات وأصحاب المشاريع والمقاولين. تأسست شركتنا بهدف تطوير الممارسات الهندسية وتعزيز معايير الجودة في القطاع الهندسي.<br>

نستفيد من خبرتنا ومعرفتنا الواسعة لخدمة عملائنا، مع فريق مختار بعناية من المهندسين ذوي المهارات العالية المتوافقين مع رؤيتنا لوضع شركتنا بين الشركات الرائدة في المجال. نسعى للتميز والابتكار في كل مشروع نقوم به، مما يضمن نجاح عملائنا وتحقيق أهدافهم بكفاءة واحترافية.<br>

باختصار، نحن شريكك المثالي لجميع احتياجات خدمات الهندسة، وملتزمون بتقديم الأفضل.
  </p>


  <button id="toggleBtn" onclick="toggleText()" class="mt-10 before:ease relative h-12 w-40 overflow-hidden border border-[#e9bc64] bg-[#e9bc64] text-white shadow-2xl transition-all before:absolute before:left-0 before:top-0 before:h-12 before:w-6 before:-translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:shadow-[#e9bc64] hover:before:translate-x-40">
    <span id="btnText" class="relative z-10">اقرأ المزيد</span>
  </button>
</div>
...
<div class="w-full bg-white py-10 px-4 sm:px-10">
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 shadow-lg  border border-gray-200 p-6 md:p-10 hover:shadow-2xl transition-all duration-300">
        ...
        <div class="flex-shrink-0">
            <img src="{{ asset('images/adelimg.png') }}" alt="م. عادل"
                class="w-40 h-40 md:w-48 md:h-48 rounded-full object-cover border-4 border-white shadow-md" />
        </div>

        <!-- Text Section -->
        <div class="text-center md:text-right flex-1">
            <h2 class="text-3xl font-bold text-gray-800">م. عادل</h2>
            <p class="text-lg text-gray-600 mt-2">المؤسس والمدير العام</p>
            <span href="#" class="text-[#e8bb5b] mt-2 inline-block hover:underline transition">شركة الأعمال المتقدمة</span>

            <!-- Optional Description -->
            <p class="mt-4 text-sm text-gray-500 leading-relaxed max-w-xl">
                شغوف بالابتكار والقيادة، كرس م. عادل حياته المهنية لبناء حلول تمكين الأعمال والفرق. رؤيته تقود شركة الأعمال المتقدمة للأمام.
            </p>
        </div>
    </div>
</div>
...
<div class="counter-box bg-black/40 rounded-lg shadow-md p-6 flex items-center space-x-4 w-64 shrink-0">
        ...
        <div>
          <p class="text-white font-medium">إجمالي المشاريع</p>
...
<div class="counter-box bg-black/40 rounded-lg shadow-md p-6 flex items-center space-x-4 w-64 shrink-0">
        ...
        <div>
          <p class="text-white font-medium">إجمالي العملاء</p>
...
<div class="counter-box bg-black/40 rounded-lg shadow-md p-6 flex items-center space-x-4 w-64 shrink-0">
        ...
        <div>
          <p class="text-white font-medium">إجمالي الموظفين</p>
...
<div class="counter-box bg-black/40 rounded-lg shadow-md p-6 flex items-center space-x-4 w-64 shrink-0">
        ...
        <div>
          <p class="text-white font-medium">إجمالي الدول</p>
...
<div class="counter-box bg-black/40 rounded-lg shadow-md p-6 flex items-center space-x-4 w-64 shrink-0">
        ...
        <div>
          <p class="text-white font-medium">إجمالي المدن</p>
...
<script>
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const observer = new IntersectionObserver((entries) => {
      ...
      threshold: 0.5,
      rootMargin: '0px 100px 0px 0px' // Adjusted for RTL
    });
...
<section class="max-w-6xl w-full mt-4 mx-auto py-12 fade-slide-left" id="Latest_News">
        <!-- Section Header -->
<div class="text-center mb-16 fade-slide-left">
    <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4 mt-10">آخر الأخبار</h2>
    <p class="text-lg text-gray-600 max-w-2xl mx-auto">ابقَ على اطلاع بآخر إعلاناتنا وقصصنا</p>
...
@foreach($news->sortByDesc('created_at')->take(3) as $item)
    ...
    <div class="mr-5 ml-5 news-item bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2">

        <div class="relative h-48 overflow-hidden">
            @if($item->image)
                <img src="{{ asset('storage/' . $item->image) }}" class="w-full h-full object-cover" />
            @endif
            <div class="absolute top-4 left-4 bg-[#e9bc64] text-white text-xs font-semibold px-3 py-1 rounded-full">
                {{ $item->title }}
            </div>
        </div>
        ...
        <div class="p-6">
            ...
            <!-- Preview -->
            <p id="preview-{{ $item->id }}" class="text-gray-600 mb-4">
                {{ $preview }}
            </p>

            <!-- Full content (hidden initially) -->
            @if($isLong)
            <p id="full-{{ $item->id }}" class="text-gray-700 mb-4 hidden">
                {{ $fullContent }}
            </p>

            <button onclick="toggleExpand({{ $item->id }})"
                class="text-[#e9bc64] font-medium hover:text-[#f5c361] inline-flex items-center">
                <span id="btnText-{{ $item->id }}">اقرأ المزيد</span>
            </button>
            @endif
        </div>
    </div>
...
>    <div class="max-w-7xl mx-auto px-2 sm:px-4">
      <div class="flex justify-center h-12 sm:h-16 items-center space-x-1 sm:space-x-2">
        ...
        >
          <span class="relative z-10">رؤيتنا</span>
          <span class="absolute inset-0 bg-gradient-to-l from-[#e9bc64] to-[#fabc40] opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full"></span>
        </button>
        <button
          onclick="showPage('page2')"
          class="relative overflow-hidden bg-white/10 hover:bg-white/20 text-white font-medium py-1 px-3 sm:py-2 sm:px-6 rounded-full transition-all duration-300 border border-white/20 hover:border-white/40 group text-xs sm:text-base"
        >
          <span class="relative z-10">مهمتنا</span>
          <span class="absolute inset-0 bg-gradient-to-l from-[#e9bc64] to-[#fabc40] opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full"></span>
        </button>
        <button
          ...
          class="relative overflow-hidden bg-white/10 hover:bg-white/20 text-white font-medium py-1 px-3 sm:py-2 sm:px-6 rounded-full transition-all duration-300 border border-white/20 hover:border-white/40 group text-xs sm:text-base"
        >
          <span class="relative z-10">قيمنا</span>
          <span class="absolute inset-0 bg-gradient-to-l from-[#e9bc64] to-[#fabc40] opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full"></span>
        </button>
      </div>
    </div>
  ...
  <div id="page1" class="hidden w-full max-w-4xl">
    <div class="backdrop-blur-lg bg-white/20 p-4 sm:p-8 rounded-3xl h-[550px] sm:h-[550px] shadow-2xl border border-white/30 text-center transition-all duration-500 transform hover:scale-[1.01]">
      <h1 class="text-2xl sm:text-4xl font-bold mb-4 sm:mb-6 text-white drop-shadow-md">رؤيتنا</h1>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mt-6 sm:mt-12">
        <div class="bg-white/10 p-4 sm:p-6 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300">
          ...
          <h3 class="text-sm sm:text-base font-semibold text-white">تطمح شركتنا الهندسية إلى تأسيس نفسها كلاعب بارز في السوق، وتقديم حلول هندسية مبتكرة وعالية الجودة. نهدف إلى أن نصبح شركة هندسية رائدة معروفة بالتزامنا بالتميز والموثوقية ورضا العملاء.</h3>
        </div>
        <div class="bg-white/10 p-4 sm:p-6 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300">
          <div class="text-2xl sm:text-3xl mb-2 sm:mb-3">🧠</div>
          <h3 class="text-sm sm:text-base font-semibold text-white">من خلال الاستفادة من خبرتنا في جميع التخصصات الهندسية، نسعى إلى تقديم نتائج استثنائية باستمرار وبناء علاقات دائمة مع عملائنا. رؤيتنا هي أن نكون في طليعة دفع التقدم التكنولوجي ووضع معايير صناعية جديدة.</h3>
        </div>
      </div>
    </div>
  </div>
...
<div id="page2" class="hidden w-full max-w-4xl">
    <div class="backdrop-blur-lg bg-white/20 p-4 sm:p-8 rounded-3xl h-[550px] sm:h-[550px] shadow-2xl border border-white/30 text-center transition-all duration-500 transform hover:scale-[1.01]">
    <h1 class="text-2xl sm:text-4xl font-bold mb-4 sm:mb-6 text-white drop-shadow-md">مهمتنا</h1>
    ...
    <div class="flex flex-col sm:flex-row justify-center items-stretch gap-6 sm:gap-8 mt-6 sm:mt-12">
      ...
      <div class="flex flex-col items-center">
        ...
        <div class="bg-white/10 p-4 rounded-xl border border-white/20 flex-1 w-full">
          <h3 class="font-semibold text-white mb-2">الابتكار</h3>
          <p class="text-white/90 text-sm sm:text-base">هدفنا الأساسي هو تقديم خدمات هندسية استثنائية لعملائنا الكرام، وضمان أعلى معايير الجودة والكفاءة والابتكار. نحن ملتزمون بالمساهمة في نجاح ونمو عملائنا من خلال تقديم حلول مخصصة تلبي احتياجاتهم المحددة. من خلال تقديم منتجات وخدمات عالية الجودة باستمرار، نسعى لتجاوز التوقعات، وتعزيز الشراكات طويلة الأمد، والحفاظ على سمعة التميز في الصناعة الهندسية.</p>
        </div>
      </div>
...
<div id="page3" class="hidden w-full max-w-4xl">
  <div class="backdrop-blur-lg bg-white/20 p-4 sm:p-8 rounded-3xl h-[550px] sm:h-[550px] shadow-2xl border border-white/30 text-center transition-all duration-500 transform hover:scale-[1.01]">
    {{-- <h1 class="text-2xl sm:text-4xl font-bold mb-4 sm:mb-6 text-white drop-shadow-md">قيمنا</h1> --}}
...
<div class="grid grid-cols-1 h-[490px] sm:grid-cols-2 gap-4 sm:gap-6 max-w-2xl mx-auto mt-2 sm:mt-0  overflow-auto sm:overflow-visible">
      <!-- Value 1 -->
      <div class="relative">
        <div class="absolute -inset-1 bg-gradient-to-l rounded-lg blur opacity-75 animate-pulse"></div>
        <div class="relative bg-white/20 rounded-lg px-4 py-3 sm:px-7 sm:py-5 border border-white/30 h-full">
          <h3 class="text-lg sm:text-xl font-semibold text-white">الالتزام البيئي</h3>
          <p class="mt-1 sm:mt-2 text-sm sm:text-base text-white/80">نحن ندرك مسؤوليتنا في تقليل التأثير البيئي لعملنا. من خلال الممارسات المستدامة، نهدف للمساهمة إيجابياً في رفاهية الكوكب والأجيال القادمة.</p>
        </div>
      </div>
        ...
        <div class="absolute -inset-1 bg-gradient-to-l  rounded-lg blur opacity-75 animate-pulse"></div>
        <div class="relative bg-white/20 rounded-lg px-4 py-3 sm:px-7 sm:py-5 border border-white/30 h-full">
          <h3 class="text-lg sm:text-xl font-semibold text-white">التركيز على العميل</h3>
          <p class="mt-1 sm:mt-2 text-sm sm:text-base text-white/80">رضا عملائنا هو الأهم. نحن ملتزمون بفهم وتلبية احتياجاتهم، وتعزيز العلاقات القوية، وتقديم حلول مخصصة وقيمة.</p>
        </div>
      </div>
        ...
        <div class="absolute -inset-1 bg-gradient-to-l rounded-lg blur opacity-75 animate-pulse"></div>
        <div class="relative bg-white/20 rounded-lg px-4 py-3 sm:px-7 sm:py-5 border border-white/30 h-full">
          <h3 class="text-lg sm:text-xl font-semibold text-white">الاحترافية</h3>
          <p class="mt-1 sm:mt-2 text-sm sm:text-base text-white/80">نتمثل الاحترافية في جميع تفاعلاتنا، من التعامل مع العملاء إلى العمليات الداخلية، ونظهر الاحترام والكفاءة والالتزام بالتميز.</p>
        </div>
      </div>
      ...
      <div class="relative">
        <div class="absolute -inset-1 bg-gradient-to-l rounded-lg blur opacity-75 animate-pulse"></div>
        <div class="relative bg-white/20 rounded-lg px-4 py-3 sm:px-7 sm:py-5 border border-white/30 h-full">
          <h3 class="text-lg sm:text-xl font-semibold text-white">القدرة على التكيف</h3>
          <p class="mt-1 sm:mt-2 text-sm sm:text-base text-white/80">نتبنى التغيير والتقدم التكنولوجي، ونسعى للبقاء مرنين ومستجيبين للاتجاهات الناشئة واحتياجات المجال الديناميكي.</p>
        </div>
      </div>
...
<section class="relative py-12 px-4 sm:px-6 lg:px-8" id="Our_Projects">
    ...
    <div class="relative max-w-7xl mx-auto">
        @if($newestProjects->count())
            <h2 class="text-2xl md:text-3xl font-bold text-white mb-6 md:mb-8 text-center">أحدث مشاريعنا</h2>
                ...
                @foreach($newestProjects as $project)
                    ...
                    >
                        <div class="p-5 sm:p-6">
                            ...
                            >
                                <span x-text="expanded ? 'اقرأ أقل' : 'اقرأ المزيد'"></span>
                                <svg
...
<section class="bg-white dark:bg-gray-900" id="Our_Team">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
    <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
      <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">فريقنا</h2>
    </div>
    <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
      ...
      <a href="/team" class="block">
        <div class="items-center h-[100%] bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 transition hover:shadow-lg hover:scale-[1.01]">
          <div class="text-5xl font-bold mr-5 mt-5 sm:mt-0">1 -</div>
          <div class="p-5">
            <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">قسم الإنشاءات</h3>
            <span class="text-gray-500 dark:text-gray-400">خدمات الإنشاءات</span>
            <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">التحليل والتصميم الإنشائي.</p>
            <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">الرسومات التنفيذية الإنشائية.</p>
            <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">التفتيش والتقييم / الترميم والتحقيقات الهندسية.</p>
            <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">خدمات استشارات المحاكاة العنصرية.</p>
          </div>
        </div>
      </a>
      ...
      <a href="/team" class="block">
        <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 transition hover:shadow-lg hover:scale-[1.01]">
          <div class="text-5xl font-bold mr-5 mt-5 sm:mt-0">2 -</div>
          <div class="p-5">
            <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">قسم العمارة</h3>
            <span class="text-gray-500 dark:text-gray-400">خدمات العمارة</span>
            <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">خدمة التصميم المعماري.</p>
            <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">خدمة التصميم الداخلي.</p>
            <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">خدمة الرسومات التنفيذية.</p>
          </div>
        </div>
      </a>
      ...
      <a href="/team" class="block">
        <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 transition hover:shadow-lg hover:scale-[1.01]">
          <div class="text-5xl font-bold mr-5 mt-5 sm:mt-0">3 -</div>
          <div class="p-5">
            <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">قسم الكهرباء</h3>
            <span class="text-gray-500 dark:text-gray-400">خدمات الكهرباء</span>
            <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">خدمة التصميم الكهربائي.</p>
            <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">خدمة الرسومات التنفيذية الكهربائية.</p>
          </div>
        </div>
      </a>
      ...
      <a href="/team" class="block">
        <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 transition hover:shadow-lg hover:scale-[1.01]">
          <div class="text-5xl font-bold mr-5 mt-5 sm:mt-0">4 -</div>
          <div class="p-5">
            <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">قسم الميكانيكا</h3>
            <span class="text-gray-500 dark:text-gray-400">خدمات الميكانيكا</span>
            <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">خدمة التصميم الميكانيكي.</p>
            <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">خدمة الرسومات التنفيذية الميكانيكية.</p>
          </div>
        </div>
      </a>
  ...
  <div class="w-full items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 transition hover:shadow-lg hover:scale-[1.01]">
    <div class="text-5xl font-bold mr-5 mt-5 sm:mt-0">5 -</div>
    <div class="p-5">
      <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">قسم النمذجة المعلوماتية للبناء (BIM)</h3>
      <span class="text-gray-500 dark:text-gray-400">خدمات BIM</span>
      <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">النمذجة ثلاثية الأبعاد.</p>
      <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">الكشف عن التعارضات وحلها.</p>
      <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">4D BIM (الجدولة الزمنية).</p>
      <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">5D BIM (تقييم التكاليف).</p>
      <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">إدارة المرافق باستخدام BIM.</p>
      <p class="mt-0 mb-1 font-light text-gray-500 dark:text-gray-400">التنسيق والتعاون في BIM.</p>
    </div>
  </div>
</a>
  </div>
...
<section class="bg-black text-white pt-8 pb-4 w-full mx-auto">
  <!-- HTML -->
  <div>
    <h2 class="text-center text-2xl mb-2 font-bold "">شركاؤنا الموثوقون</h2>
    <p class="text-center text-lg font-extralight ">
      نتعاون مع رواد الصناعة حول العالم
    </p>
  </div>
  ...
  <div
    class="logos group relative overflow-hidden whitespace-nowrap py-10 [mask-image:_linear-gradient(to_left,_transparent_0,_white_128px,white_calc(100%-128px),_transparent_100%)]"
  >
...
.animate-partners-scroll {
  animation: scroll-partners-right 20s linear infinite;
}
...
<!-------------------------------------------------------------->
    ...
    <div class="fixed bottom-6 left-6 z-50 font-sans group">
        ...
        <div id="chatPopup" class="hidden w-96 h-[500px] bg-white shadow-2xl rounded-2xl flex flex-col overflow-hidden animate-fade-in">
            ...
            <div id="chatBody" class="flex-1 p-4 overflow-y-auto space-y-4 bg-gray-50">
                <div class="bg-gray-100 p-3 rounded-xl max-w-[80%] text-sm">
                    👋 مرحباً! أنا مساعد شركة الأعمال المتقدمة للهندسة. اسألني أي شيء أدناه.
                </div>

                <!-- Static Response Buttons -->
                <div id="optionButtons" class="flex flex-col gap-2 mt-2">
                    <button onclick="selectOption(this)" class="bg-blue-600 text-white rounded-lg px-4 py-2 hover:bg-blue-700 transition text-right">متى تأسست شركة الأعمال المتقدمة للهندسة؟</button>
                    <button onclick="selectOption(this)" class="bg-blue-600 text-white rounded-lg px-4 py-2 hover:bg-blue-700 transition text-right">أين يقع مقر شركة الأعمال المتقدمة للهندسة؟</button>
                    <button onclick="selectOption(this)" class="bg-blue-600 text-white rounded-lg px-4 py-2 hover:bg-blue-700 transition text-right">ما هي الخدمات التي تقدمها شركة الأعمال المتقدمة للهندسة؟</button>
                    <button onclick="selectOption(this)" class="bg-blue-600 text-white rounded-lg px-4 py-2 hover:bg-blue-700 transition text-right">ما هي فرص العمل المتاحة؟</button>
                </div>
            </div>
            ...
            <div class="flex items-center p-4 border-t bg-gray-100">
                ...
                <button onclick="sendMessage()" class="mr-3 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-full shadow-md transition">
                    إرسال
                </button>
            </div>
        </div>
        ...
        <button id="chatButton" onclick="toggleChat()" class="bg-blue-600 hover:bg-blue-700 text-white w-16 h-16 rounded-full shadow-xl flex items-center justify-center relative group">
            <!-- Tooltip -->
            <span class="absolute -right-28 bottom-5 opacity-0 group-hover:opacity-100 transition bg-gray-800 text-white text-sm py-1 px-3 rounded-lg shadow-lg">
                تحدث معنا
            </span>
            <!-- Chatbot Icon -->
...
<div id="contactForm" class="hidden mt-6">
  ...
  >
    ...
    <p id="formStatus" class="text-sm text-green-600 mt-4 hidden">شكراً! تم إرسال رسالتك بنجاح.</p>
  </form>
</div>
  ...
  document.getElementById('customContactForm').addEventListener('submit', async function(e) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        statusMessage.textContent = "شكراً! تم إرسال رسالتك بنجاح.";
      } else {
        statusMessage.classList.remove('hidden');
        statusMessage.textContent = "حدث خطأ! يرجى المحاولة مرة أخرى.";
        statusMessage.classList.add('text-red-600');
      }
    } catch (error) {
      statusMessage.classList.remove('hidden');
      statusMessage.textContent = "خطأ في إرسال النموذج. حاول مرة أخرى لاحقاً.";
      statusMessage.classList.add('text-red-600');
    }
  });
</script>
                ...
                <!--End Col-->
                <div class="lg:mx-auto text-right ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">روابط سريعة</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href=""  class="text-gray-600 hover:text-gray-900">الرئيسية</a></li>
                        <li class="mb-6"><a href="#Our_Services"  class=" text-gray-600 hover:text-gray-900">خدماتنا</a></li>
                        <li class="mb-6"><a href="#Our_Team"  class=" text-gray-600 hover:text-gray-900">فريقنا</a></li>
                        <li><a href="#Our_Projects"  class=" text-gray-600 hover:text-gray-900">مشاريعنا</a></li>
                    </ul>
                </div>
                <!--End Col-->
                <div class="lg:mx-auto text-right ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">العنوان</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"  class="text-gray-600 hover:text-gray-900">الأردن</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">المملكة العربية السعودية</a></li>

                    </ul>
                </div>
                <!--End Col-->
                <div class="lg:mx-auto text-right">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">الهاتف</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"  class="text-gray-600 hover:text-gray-900">الأردن: +962 798984004</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">الأردن: +962 6523472</a></li>
                    </ul>
                </div>
                <!--End Col-->
                <div class="lg:mx-auto text-right">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">البريد الإلكتروني</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">البريد الإلكتروني: INFO@AW-ENGINEERING.NET</a></li>
                    </ul>
                </div>
            </div>
            <!--Grid-->
            <div class="py-7 border-t border-gray-200">
                <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span class="text-sm text-gray-500 ">©<a>الأعمال المتقدمة للهندسة</a> 2025، جميع الحقوق محفوظة.</span>
